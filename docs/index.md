...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: Leave a Star ⭐
      link: https://github.com/jacobcxdev/gemini-mcp-tool
...
For installation and setup instructions, refer to the [jacobcxdev fork README](https://github.com/jacobcxdev/gemini-mcp-tool#readme). This fork is intended for local Claude Code use and preserves Gemini CLI OAuth without requiring an API key.
